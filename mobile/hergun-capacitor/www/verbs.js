const verbsData = [
  ...
  },
  {
    ...
    "forms": {
      ...
      "present": {
        "arabic": "يَقْطُرُ",
        "translation": "damcıladır",
        "examples": [
          {
            "arabic": "هُوَ يَقْطُرُ الآنَ.",
            "translation": "O, indi damcıladır."
          }
        ]
      },
      "imperative": {
...
const nibrasFirstHundredRootPromotions = [
  [22, ['سَفَرَ', 'açmaq, üzə çıxarmaq', 'سَفَرَ', 'açdı', 'يَسْفِرُ', 'açır', 'اِسْفِرْ', 'aç!']],
  [36, 465],
  [37, ['صَلَا', 'yanmaq, odda qızarmaq', 'صَلَا', 'yandı / odda qızardı', 'يَصْلَى', 'yanır / odda qızarır', 'اِصْلَ', 'yan!']],
  [41, ['شَرَى', 'satmaq', 'شَرَى', 'satdı', 'يَشْرِي', 'satır', 'اِشْرِ', 'sat!']],
  [45, ['كَلَمَ', 'yaralamaq', 'كَلَمَ', 'yaraladı', 'يَكْلِمُ', 'yaralayır', 'اِكْلِمْ', 'yarala!']],
  [48, ['جَابَ', 'keçmək, yarmaq', 'جَابَ', 'keçdi / yardı', 'يَجُوبُ', 'keçir / dolaşır', 'جُبْ', 'keç!']],
  [60, ['وَضُؤَ', 'təmiz və gözəl olmaq', 'وَضُؤَ', 'təmiz və gözəl oldu', 'يَوْضُؤُ', 'təmiz və gözəl olur', 'اِوْضُؤْ', 'təmiz ol!']],
  [64, ['دَبَرَ', 'arxasınca getmək, idarə etmək', 'دَبَرَ', 'arxasınca getdi / idarə etdi', 'يَدْبُرُ', 'arxasınca gedir / idarə edir', 'اُدْبُرْ', 'arxasınca get!']],
  [65, 675],
  [66, 675],
  [70, ['سَعِدَ', 'xoşbəxt olmaq', 'سَعِدَ', 'xoşbəxt oldu', 'يَسْعَدُ', 'xoşbəxt olur', 'اِسْعَدْ', 'xoşbəxt ol!']],
  [71, 52],
  [72, ['نَفَقَ', 'keçmək, tuneldən keçmək', 'نَفَقَ', 'keçdi', 'يَنْفُقُ', 'keçir', 'اُنْفُقْ', 'keç!']],
  [75, ['جَنَبَ', 'yan keçmək, uzaqlaşdırmaq', 'جَنَبَ', 'yan keçdi / uzaqlaşdırdı', 'يَجْنُبُ', 'yan keçir / uzaqlaşdırır', 'اِجْنُبْ', 'yan keç!']],
  [80, ['وَفَى', 'vəfa etmək, yerinə yetirmək', 'وَفَى', 'vəfa etdi', 'يَفِي', 'vəfa edir', 'فِ', 'vəfa et!']],
  [81, 717],
  [82, 730],
  [84, ['وَكَلَ', 'tapşırmaq, həvalə etmək', 'وَكَلَ', 'tapşırdı / həvalə etdi', 'يَكِلُ', 'tapşırır / həvalə edir', 'كِلْ', 'tapşır!']],
  [86, ['طَاعَ', 'itaət etmək', 'طَاعَ', 'itaət etdi', 'يَطِيعُ', 'itaət edir', 'أَطِعْ', 'itaət et!']],
  [90, ['حَبَّ', 'sevmək', 'حَبَّ', 'sevdi', 'يَحِبُّ', 'sevir', 'حِبَّ', 'sev!']],
  [92, ['عَهَدَ', 'əhd etmək, öhdəsinə götürmək', 'عَهَدَ', 'əhd etdi / öhdəsinə götürdü', 'يَعْهَدُ', 'əhd edir / öhdəsinə götürür', 'اِعْهَدْ', 'əhd et!']],
  [93, ['عَانَ', 'kömək etmək', 'عَانَ', 'kömək etdi', 'يَعِينُ', 'kömək edir', 'أَعِنْ', 'kömək et!']],
  [94, ['جَهَدَ', 'səy göstərmək', 'جَهَدَ', 'səy göstərdi', 'يَجْهَدُ', 'səy göstərir', 'اِجْهَدْ', 'səy göstər!']],
  [95, ['وَسَلَ', 'yaxınlaşmaq, vəsilə etmək', 'وَسَلَ', 'yaxınlaşdı / vəsilə etdi', 'يَسِلُ', 'yaxınlaşır / vəsilə edir', 'اِسِلْ', 'yaxınlaş!']],
  [97, ['لَزِمَ', 'bağlı qalmaq', 'لَزِمَ', 'bağlı qaldı', 'يَلْزَمُ', 'bağlı qalır', 'اِلْزَمْ', 'bağlı qal!']],
  [98, 19]
];
...
const nibrasDuplicateRootSlotReplacements = [
  [19, ['قَرُبَ', 'yaxın olmaq', 'قَرُبَ', 'yaxın oldu', 'يَقْرُبُ', 'yaxın olur', 'اِقْرُبْ', 'yaxın ol!']],
  [52, ['كَبُرَ', 'böyük olmaq', 'كَبُرَ', 'böyük oldu', 'يَكْبُرُ', 'böyük olur', 'اُكْبُرْ', 'böyük ol!']],
  [66, ['صَغُرَ', 'kiçik olmaq', 'صَغُرَ', 'kiçik oldu', 'يَصْغُرُ', 'kiçik olur', 'اِصْغُرْ', 'kiçik ol!']],
  [465, ['عَدَلَ', 'ədalətli olmaq, düzəltmək', 'عَدَلَ', 'ədalətli oldu / düzəltdi', 'يَعْدِلُ', 'ədalətli olur / düzəldir', 'اِعْدِلْ', 'ədalətli ol / düzəlt!']],
  [675, ['رَفَقَ', 'mülayim davranmaq', 'رَفَقَ', 'mülayim davrandı', 'يَرْفُقُ', 'mülayim davranır', 'اِرْفُقْ', 'mülayim davran!']],
  [717, ['عَجِبَ', 'təəccüblənmək', 'عَجِبَ', 'təəccübləndi', 'يَعْجَبُ', 'təəccüblənir', 'اِعْجَبْ', 'təəccüblən!']],
  [730, ['خَجِلَ', 'utanmaq', 'خَجِلَ', 'utandı', 'يَخْجَلُ', 'utanır', 'اِخْجَلْ', 'utan!']]
];
...
const nibrasSecondHundredRootPromotions = [
  [101, ['زَوَجَ', 'cütləşdirmək, qoşmaq', 'زَوَجَ', 'cütləşdirdi / qoşdu', 'يَزْوِجُ', 'cütləşdirir / qoşur', 'اِزْوِجْ', 'cütləşdir!']],
  [102, ['طَلَقَ', 'azad buraxmaq', 'طَلَقَ', 'azad buraxdı', 'يَطْلُقُ', 'azad buraxır', 'اِطْلُقْ', 'azad burax!']],
  [103, ['رَبَا', 'artmaq, böyümək', 'رَبَا', 'artdı / böyüdü', 'يَرْبُو', 'artır / böyüyür', 'اِرْبُ', 'art!']],
  [110, ['سَهَمَ', 'pay almaq, iştirak etmək', 'سَهَمَ', 'pay aldı / iştirak etdi', 'يَسْهَمُ', 'pay alır / iştirak edir', 'اِسْهَمْ', 'iştirak et!']],
  [111, ['بَدَرَ', 'önə keçmək, tələsmək', 'بَدَرَ', 'önə keçdi / tələsdi', 'يَبْدُرُ', 'önə keçir / tələsir', 'اُبْدُرْ', 'önə keç!']],
  [112, ['أَخَرَ', 'gecikdirmək', 'أَخَرَ', 'gecikdirdi', 'يَأْخُرُ', 'gecikdirir', 'أَخِّرْ', 'gecikdir!']],
  [113, ['قَدِمَ', 'gəlmək, varmaq', 'قَدِمَ', 'gəldi / vardı', 'يَقْدَمُ', 'gəlir / varır', 'اِقْدَمْ', 'irəli gəl!']],
  [115, ['هَمَّ', 'niyyət etmək, qayğılanmaq', 'هَمَّ', 'niyyət etdi / qayğılandı', 'يَهُمُّ', 'niyyət edir / qayğılanır', 'هِمَّ', 'niyyət et!']],
  [116, ['أَدُبَ', 'ədəbli olmaq', 'أَدُبَ', 'ədəbli oldu', 'يَأْدُبُ', 'ədəbli olur', 'اُؤْدُبْ', 'ədəbli ol!']],
  [117, ['شَجُعَ', 'cəsur olmaq', 'شَجُعَ', 'cəsur oldu', 'يَشْجُعُ', 'cəsur olur', 'اُشْجُعْ', 'cəsur ol!']],
  [121, ['وَقُرَ', 'vüqarlı olmaq', 'وَقُرَ', 'vüqarlı oldu', 'يَوْقُرُ', 'vüqarlı olur', 'اُوْقُرْ', 'vüqarlı ol!']],
  [122, ['حَرُمَ', 'qadağan olmaq', 'حَرُمَ', 'qadağan oldu', 'يَحْرُمُ', 'qadağan olur', 'اُحْرُمْ', 'qadağan ol!']],
  [123, ['كَرُمَ', 'səxavətli olmaq', 'كَرُمَ', 'səxavətli oldu', 'يَكْرُمُ', 'səxavətli olur', 'اُكْرُمْ', 'səxavətli ol!']],
  [125, ['صَحِبَ', 'yoldaşlıq etmək', 'صَحِبَ', 'yoldaşlıq etdi', 'يَصْحَبُ', 'yoldaşlıq edir', 'اِصْحَبْ', 'yoldaşlıq et!']],
  [127, ['فَرَقَ', 'ayırmaq', 'فَرَقَ', 'ayırdı', 'يَفْرُقُ', 'ayırır', 'اُفْرُقْ', 'ayır!']],
  [128, ['حَذِقَ', 'bacarıqlı olmaq', 'حَذِقَ', 'bacarıqlı oldu', 'يَحْذَقُ', 'bacarıqlı olur', 'اِحْذَقْ', 'bacarıqlı ol!']],
  [129, ['خَفُتَ', 'zəifləmək, sakitləşmək', 'خَفُتَ', 'zəiflədi / sakitləşdi', 'يَخْفُتُ', 'zəifləyir / sakitləşir', 'اِخْفُتْ', 'sakitləş!']],
  [131, ['خَصَمَ', 'mübahisə etmək', 'خَصَمَ', 'mübahisə etdi', 'يَخْصِمُ', 'mübahisə edir', 'اِخْصِمْ', 'mübahisə et!']],
  [132, ['شَارَ', 'məsləhətləşmək, işarə etmək', 'شَارَ', 'məsləhətləşdi / işarə etdi', 'يَشِيرُ', 'məsləhətləşir / işarə edir', 'أَشِرْ', 'işarə et!']],
  [133, ['جَمُلَ', 'gözəl olmaq', 'جَمُلَ', 'gözəl oldu', 'يَجْمُلُ', 'gözəl olur', 'اُجْمُلْ', 'gözəl ol!']],
  [135, 813],
  [137, ['سَلِمَ', 'salamat olmaq', 'سَلِمَ', 'salamat oldu', 'يَسْلَمُ', 'salamat olur', 'اِسْلَمْ', 'salamat ol!']],
  [139, ['عَنَقَ', 'qucaq açmaq', 'عَنَقَ', 'qucaq açdı', 'يَعْنُقُ', 'qucaq açır', 'اِعْنُقْ', 'qucaq aç!']],
  [140, ['ضَافَ', 'qonaq olmaq, qonaq etmək', 'ضَافَ', 'qonaq oldu / qonaq etdi', 'يَضِيفُ', 'qonaq olur / qonaq edir', 'ضِفْ', 'qonaq ol!']],
  [141, ['طَعِمَ', 'dadmaq, yemək', 'طَعِمَ', 'dadı / yedi', 'يَطْعَمُ', 'dadı / yeyir', 'اِطْعَمْ', 'dad!']],
  [143, ['شَغَلَ', 'məşğul etmək', 'شَغَلَ', 'məşğul etdi', 'يَشْغَلُ', 'məşğul edir', 'اِشْغَلْ', 'məşğul et!']],
  [149, ['نَدَا', 'səxavətli olmaq, nəmlənmək', 'نَدَا', 'səxavətli oldu / nəmləndi', 'يَنْدُو', 'səxavətli olur / nəmlənir', 'اُنْدُ', 'səxavətli ol!']],
  [151, ['نَذَرَ', 'nəzir etmək, xəbərdar etmək', 'نَذَرَ', 'nəzir etdi / xəbərdar etdi', 'يَنْذُرُ', 'nəzir edir / xəbərdar edir', 'اُنْذُرْ', 'xəbərdar et!']],
  [152, 229],
  [153, ['دَالَ', 'növbələşmək, dövr etmək', 'دَالَ', 'növbələşdi / dövr etdi', 'يَدُولُ', 'növbələşir / dövr edir', 'دُلْ', 'növbələş!']],
  [154, ['دَلَّ', 'dəlalət etmək, göstərmək', 'دَلَّ', 'göstərdi', 'يَدُلُّ', 'göstərir', 'دُلَّ', 'göstər!']],
  [156, 47],
  [157, ['فَسَرَ', 'izah etmək', 'فَسَرَ', 'izah etdi', 'يَفْسِرُ', 'izah edir', 'اِفْسِرْ', 'izah et!']],
  [162, ['شَرِكَ', 'şərik olmaq', 'شَرِكَ', 'şərik oldu', 'يَشْرَكُ', 'şərik olur', 'اِشْرَكْ', 'şərik ol!']],
  [163, ['وَحَدَ', 'tək olmaq, birləşmək', 'وَحَدَ', 'tək oldu / birləşdi', 'يَحِدُ', 'tək olur / birləşir', 'حِدْ', 'tək ol!']],
  [164, ['خَلَفَ', 'ardınca gəlmək, əvəz etmək', 'خَلَفَ', 'ardınca gəldi / əvəz etdi', 'يَخْلُفُ', 'ardınca gəlir / əvəz edir', 'اِخْلُفْ', 'əvəz et!']],
  [165, ['وَفَقَ', 'uyğun gəlmək', 'وَفَقَ', 'uyğun gəldi', 'يَفِقُ', 'uyğun gəlir', 'فِقْ', 'uyğun gəl!']],
  [167, 240],
  [168, 551],
  [173, ['عَذَرَ', 'üzrlü saymaq', 'عَذَرَ', 'üzrlü saydı', 'يَعْذِرُ', 'üzrlü sayır', 'اِعْذِرْ', 'üzrlü say!']],
  [175, ['عَزَا', 'aid etmək, təsəlli vermək', 'عَزَا', 'aid etdi / təsəlli verdi', 'يَعْزُو', 'aid edir / təsəlli verir', 'اِعْزُ', 'aid et!']],
  [177, ['عَمَرَ', 'abadlaşdırmaq, məskunlaşdırmaq', 'عَمَرَ', 'abadlaşdırdı / məskunlaşdırdı', 'يَعْمُرُ', 'abadlaşdırır / məskunlaşdırır', 'اُعْمُرْ', 'abadlaşdır!']],
  [181, ['ظَرُفَ', 'zərif və bacarıqlı olmaq', 'ظَرُفَ', 'zərif və bacarıqlı oldu', 'يَظْرُفُ', 'zərif və bacarıqlı olur', 'اِظْرُفْ', 'zərif ol!']],
  [182, ['قَرَضَ', 'kəsmək, borc vermək', 'قَرَضَ', 'kəsdi / borc verdi', 'يَقْرِضُ', 'kəsir / borc verir', 'اِقْرِضْ', 'borc ver!']],
  [183, ['بَطُؤَ', 'yavaş olmaq', 'بَطُؤَ', 'yavaş oldu', 'يَبْطُؤُ', 'yavaş olur', 'اِبْطُؤْ', 'yavaş ol!']],
  [184, ['وَرِثَ', 'miras almaq', 'وَرِثَ', 'miras aldı', 'يَرِثُ', 'miras alır', 'اِرِثْ', 'miras al!']],
  [185, ['تَجَرَ', 'ticarət etmək', 'تَجَرَ', 'ticarət etdi', 'يَتْجُرُ', 'ticarət edir', 'اِتْجُرْ', 'ticarət et!']],
  [187, ['جَمُدَ', 'möhkəm və donuq olmaq', 'جَمُدَ', 'möhkəm və donuq oldu', 'يَجْمُدُ', 'möhkəm və donuq olur', 'اُجْمُدْ', 'möhkəm ol!']],
  [189, ['أَجَرَ', 'icarəyə vermək, mükafatlandırmaq', 'أَجَرَ', 'icarəyə verdi / mükafatlandırdı', 'يَأْجُرُ', 'icarəyə verir / mükafatlandırır', 'آجِرْ', 'icarəyə ver!']],
  [190, ['وَرَعَ', 'pəhrizkar olmaq, çəkinmək', 'وَرَعَ', 'pəhrizkar oldu / çəkindi', 'يَرَعُ', 'pəhrizkar olur / çəkinir', 'اِرَعْ', 'çəkin!']],
  [191, ['ثَمَرَ', 'bəhrə vermək', 'ثَمَرَ', 'bəhrə verdi', 'يَثْمُرُ', 'bəhrə verir', 'اُثْمُرْ', 'bəhrə ver!']],
  [192, ['ذَخَرَ', 'yığmaq, saxlamaq', 'ذَخَرَ', 'yığdı / saxladı', 'يَذْخَرُ', 'yığır / saxlayır', 'اِذْخَرْ', 'yığ!']],
  [193, 479],
  [195, ['حَيِيَ', 'utanmaq, həyalı olmaq', 'حَيِيَ', 'utandı / həyalı oldu', 'يَحْيَا', 'utanır / həyalı olur', 'اِحْيَ', 'həyalı ol!']],
  [196, ['حَشِمَ', 'utanmaq, həya etmək', 'حَشِمَ', 'utandı / həya etdi', 'يَحْشَمُ', 'utanır / həya edir', 'اِحْشَمْ', 'həya et!']],
  [197, ['وَقَى', 'qorumaq', 'وَقَى', 'qorudu', 'يَقِي', 'qoruyur', 'قِ', 'qoru!']],
  [198, ['خَارَ', 'seçmək, xeyir diləmək', 'خَارَ', 'seçdi / xeyir dilədi', 'يَخِيرُ', 'seçir / xeyir diləyir', 'خِرْ', 'seç!']],
  [200, ['وَهَبَ', 'hədiyyə etmək, bağışlamaq', 'وَهَبَ', 'hədiyyə etdi / bağışladı', 'يَهَبُ', 'hədiyyə edir / bağışlayır', 'هَبْ', 'hədiyyə et!']]
];
...
const nibrasSecondHundredDuplicateRootSlotReplacements = [
  [47, ['وَجِلَ', 'qorxmaq', 'وَجِلَ', 'qorxdu', 'يَوْجَلُ', 'qorxur', 'اِوْجَلْ', 'qorx!']],
  [229, ['نَبَغَ', 'üstün olmaq, parlaqlaşmaq', 'نَبَغَ', 'üstün oldu / parlaqlaşdı', 'يَنْبُغُ', 'üstün olur / parlaqlaşır', 'اِنْبُغْ', 'üstün ol!']],
  [240, ['رَشَدَ', 'doğru yol tapmaq', 'رَشَدَ', 'doğru yol tapdı', 'يَرْشُدُ', 'doğru yol tapır', 'اِرْشُدْ', 'doğru yol tap!']],
  [479, ['عَذُبَ', 'şirin və xoş olmaq', 'عَذُبَ', 'şirin və xoş oldu', 'يَعْذُبُ', 'şirin və xoş olur', 'اُعْذُبْ', 'şirin ol!']],
  [551, ['خَبُثَ', 'pis olmaq', 'خَبُثَ', 'pis oldu', 'يَخْبُثُ', 'pis olur', 'اُخْبُثْ', 'pis ol!']],
  [813, ['فَطِنَ', 'zirək olmaq', 'فَطِنَ', 'zirək oldu', 'يَفْطَنُ', 'zirək olur', 'اِفْطَنْ', 'zirək ol!']]
];
